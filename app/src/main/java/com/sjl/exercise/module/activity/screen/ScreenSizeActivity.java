...
public class ScreenSizeActivity extends BaseActivity {
    ...
    public int getContentLayout() {
        return R.layout.activity_screen_size;
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        tvText.setText(String.format("onConfigurationChanged：%s", newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE ? "竖屏" : "横屏"));
